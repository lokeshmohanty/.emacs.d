...
#+begin_src emacs-lisp
    ...
    (use-package avy
      ...
      ;; :general
      ;; ("M-j" '(avy-goto-char-timer :which-key "Avy goto char timer"))
      ;; :bind* (
      ...
      (my/leader-keys
        ...
        "jj"  '(avy-goto-char-timer :which-key "Avy goto char timer")
...
This is based on [[https://en.wikipedia.org/wiki/Zettelkasten][zettelkasten]] (box of paper slips in German) which is used for note taking and for personal knowledge management.

[[https://www.orgroam.com/manual.html#The-Templating-System][org roam capture templates]]
...
#+begin_src emacs-lisp
  ...
  (use-package define-word
    ...
    (setq define-word-offline-dict-directory "~/.emacs.d/dictionaries_enwiktionary"))
    ;; (defun url-http-user-agent-string ()
    ;; "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.80 Safari/537.36 ")

  ;; (my/ctrl-c-keys
  ;;   "D"   '(define-word :which-key "search definition of a word")
  ;;   "d"   '(define-word-at-point :which-key "search definition at point")
  ;;   )
...
#+begin_src emacs-lisp
  ...
  (defun my/circe-nickserv-password (server)
    ...
    (my/circe-fetch-password :login "lokesh1197" :machine "irc.libera.chat"))
  :custom
...
- [ ] [[https://github.com/abo-abo/worf][Worf]] (vi like keybindings for speed org file management)
...
** TODO Replace projectile with project.el
:LOGBOOK:
- State "TODO"       from              [2021-10-24 Sun 10:31]
:END:
** TODO Add built-in functions to my work-flow
:LOGBOOK:
- State "TODO"       from              [2021-10-24 Sun 10:31]
:END:
* REFERENCES
